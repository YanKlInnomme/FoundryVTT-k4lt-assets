 ...
 * Ajout de contenus additionnels, générés par IA, pour la campagne "La Madone Noire" :
    ...
    - Illustrations de lieux clés de la campagne : 11 images
    - Illustrations d'éléments scénaristiques : 3 images
    - Pistes audio pour améliorer l'immersion des joueurs : 3 fichiers MP3
 * Correction mineure dans le packaging du module (dossier modules manquant)
...
## Version 2.3.0
 * Addition of additional content, generated by AI, for the campaign "The Black Madonna":
    - Illustrations for all non-player characters (NPCs): 62 portraits
    - Illustrations of key locations in the campaign: 11 images
    - Illustrations of storyline elements: 3 images
    - Audio tracks to enhance player immersion: 3 MP3 files
 * Minor correction in the module packaging (missing modules folder)
